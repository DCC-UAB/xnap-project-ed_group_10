...
def inference_test():
    ...
    img = "./data/bussiness.png"
    img = "./data/hand_write.png"
    img = "./data/tienda-tabaco.jpg"
    img = "./data/mcdonalds.jpg"
    img = "./data/iglesia.png"
    ...
    if img == "./data/Summertown-1080x675.jpg":
        OCR_tokens = [
            'GAIL', 
            'ARTISAN', 
            'BAKERY'
    ...
    if img == "./data/bussiness.png":
        OCR_tokens = [
            'BUSSINESS',
            ] # Simulate a perfect OCR output
        
    if img == "./data/hand_write.png":
        OCR_tokens = [
            'BAKERY',
            ] # Simulate a perfect OCR output
    
    if img == "./data/tienda-tabaco.jpg":
        OCR_tokens = [
            'TABACOS',
            ]
        
    if img == "./data/mcdonalds.jpg":
        OCR_tokens = [
            'MCDONALD\'S',
            'MCAFÉ'
            ]
        
    if img == "./data/iglesia.png":
        OCR_tokens = []
